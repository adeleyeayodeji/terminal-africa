...
function ProcessedShipmentSide({
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }))), shippingStatus.title == "confirmed" && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    onClick: event => cancelTerminalShipment(event.currentTarget, event)
  }, "Cancel Shipment"), selectedCarrier == "store-pickup" && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    href: "javascript:;",
    ...
    onClick: event => markTerminalShipmentCollected(event.currentTarget, event),
    style: {
      padding: "8px 8px"
    }
  }, "Mark as collected")));
